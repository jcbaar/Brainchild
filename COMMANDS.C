...
COMMAND	ComTable[] = {
	...
	{ CID_EDIT_SORTLINES,		SortLines,		_T("EditSortLines")		},
	{ CID_EDIT_COMMENTSELECTION,	CommentSelection,	_T("EditCommentSelection")	},
	{ CID_EDIT_UNCOMMENTSELECTION,	UncommentSelection,	_T("EditUncommentSelection")	},
	...
	{ CID_FIND_SET_INCREMENTAL_MODE,SetIncrementalMode,	_T("FindSetIncrementalMode")	},
	{ CID_FIND_CLEAR_INCREMENTAL_MODE,ClearIncrementalMode,	_T("FindClearIncrementalMode")	},
